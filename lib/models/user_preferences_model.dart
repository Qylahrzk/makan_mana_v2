...
class UserPreferencesModel extends Equatable {
  ...
  UserPreferencesModel copyWith({
    bool? halal, bool? vegetarian, bool? vegan,
    List<String>? cuisineTypes,
    bool? hasParking, bool? hasWifi, bool? hasAc,
    bool? hasOutdoor, bool? accessible,
    bool? familyFriendly, bool? groupFriendly, bool? casual,
    bool? romantic, bool? scenicView,
    bool? worthIt, bool? fastService,
  ...
  bool get hasAnyPreference =>
      ...
      hasParking || hasWifi || hasAc || hasOutdoor || accessible ||
      familyFriendly || groupFriendly || casual ||
      romantic || scenicView || worthIt || fastService ||
  ...
  String toString() =>
      ...
      'romantic: $romantic, scenic: $scenicView, '
      'worthIt: $worthIt, fastService: $fastService, '
      'radius: $defaultRadius)';

  @override
  List<Object?> get props => [
    userId, halal, vegetarian, vegan, cuisineTypes,
    hasParking, hasWifi, hasAc, hasOutdoor, accessible,
    familyFriendly, groupFriendly, casual, romantic, scenicView,
    worthIt, fastService, defaultRadius,
  ];
}
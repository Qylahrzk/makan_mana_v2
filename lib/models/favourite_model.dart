...
/// Represents a single favourite entry in the app.
/// Maps to the 'wishlists' table in Supabase (table name kept for backward compatibility).
///
...
class FavouriteModel extends Equatable {
  ...
  @override
  String toString() =>
      'FavouriteModel(id: $id, restaurantName: $restaurantName, '

...
class _RecommendationScreenState extends State<RecommendationScreen>
  ...
  Color _rankColor(int index) {
    switch (index) {
      case 0: return const Color(0xFFFF8C42);
      case 1: return const Color(0xFF7B8FA1);
      case 2: return const Color(0xFFB87333);
      default: return const Color(0xFFCBD5E0);
    }
  }
  ...
  Color? _rankBg(int index, BuildContext context) {
    ...
    switch (index) {
      case 0: return const Color(0xFFFFF3E8);
      case 1: return const Color(0xFFF2F4F6);
      case 2: return const Color(0xFFF7EFE8);
    ...
    return Scaffold(
      ...
      body: CustomScrollView(
        ...
        slivers: [
          ...
          if (widget.relaxedFilters.isNotEmpty)
            _buildRelaxedWarning(),
          _buildSectionLabel(),
          _buildResultsList(),
          ...
          ClipRRect(
            ...
            child: CachedNetworkImage(
              imageUrl: RestaurantImage.getUrl(
                  target.cuisineType, seed: target.id),
              width: 52,
              height: 52,
              fit: BoxFit.cover,
            ...
            child: Column(
              ...
              children: [
                ...
                Row(children: [
                  ...
                  Text(AppUtils.formatRating(target.rating),
                      style: TextStyle(
                          fontSize: 12,
                          fontWeight: FontWeight.w700,
                          color: Theme.of(context).colorScheme.onSurface)),
        ...
        (context, index) {
          ...
          return AnimatedBuilder(
            ...
            child: _buildRankCard(
                context, index, widget.recommendations[index]),
          );
        },
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text('${r.categories} · ${r.cuisineType}',
                      style: TextStyle(
                          fontSize: 11,
                          color: AppColors.secondary,
                          fontWeight: FontWeight.w500)),
                  const SizedBox(height: 5),
                  if (r.topicLabel.isNotEmpty &&
                      r.topicLabel != 'No Reviews')
                    Container(
                  ...
                  Row(children: [
                    ...
                    Icon(Icons.access_time_rounded,
                        ...
                        color: Theme.of(context)
                            ...
                            .withValues(alpha: 0.45)),
                    const SizedBox(width: 3),
                    Text('$mins min · ${km.toStringAsFixed(1)} km',
                        style: TextStyle(
                            fontSize: 11,
                            color: Theme.of(context)
                                .colorScheme
  ...
  Widget _thumbnailFallback({required bool isTopThree}) => Container(
        ...
        decoration: BoxDecoration(
          gradient: LinearGradient(
            colors: [
              AppColors.primary.withValues(alpha: isTopThree ? 0.18 : 0.10),
              AppColors.secondary
                  .withValues(alpha: isTopThree ? 0.12 : 0.07),
            ],
            begin: Alignment.topLeft,
            end: Alignment.bottomRight,
          ),

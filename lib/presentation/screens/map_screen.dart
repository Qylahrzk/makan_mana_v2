...
class _MapScreenState extends State<MapScreen>
  ...
  LatLng _ktCenter = LatLng(
      LocationService.fallbackLat, LocationService.fallbackLon);
  ...
  double _getDistance(Restaurant r) => AppUtils.calculateDistance(
      _userLat, _userLon, r.lat ?? _userLat, r.lon ?? _userLon);
  ...
  void _rebuildMarkers(List<Restaurant> restaurants) {
    final filtered = restaurants.where(
        (r) => r.lat != null && r.lon != null).toList();
  ...
  void _recenterMap() {
    _mapController?.animateCamera(
      CameraUpdate.newLatLngZoom(_ktCenter, 13),
    );
  }
  ...
  (String, Color)? _priceInfo(int level) {
    switch (level) {
      case 1: return ('RM Budget',      const Color(0xFF16A34A));
      case 2: return ('RM Moderate',    const Color(0xFF2563EB));
      case 3: return ('RM Upscale',     const Color(0xFFD97706));
      case 4: return ('RM Fine Dining', const Color(0xFFDC2626));
      default: return null;
    }
  }
          ...
          Positioned.fill(
            child: GoogleMap(
              initialCameraPosition:
                  CameraPosition(target: _ktCenter, zoom: 13),
              markers:                 _markers,
                ...
                children: [
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(children: [
                            ...
                            // Price level badge — omitted if null
                            if (price != null) ...[
                              const SizedBox(width: 8),
                              Container(
                                padding: const EdgeInsets.symmetric(
                  ...
                  if (attrs.isNotEmpty) ...[
                    ...
                    Wrap(
                      ...
                      children: attrs.take(3).map((a) => Container(
                        padding: const EdgeInsets.symmetric(
